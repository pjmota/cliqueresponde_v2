...
const CreateOrUpdateContactService = async ({
  ...
  try {
    ...
    let updateImage = (!contact || contact?.profilePicUrl !== profilePicUrl && profilePicUrl !== "") && (wbot || ['instagram', 'facebook'].includes(channel)) || false;
    ...
    if (contact) {
      ...
      if (!fs.existsSync(fileName) || contact.profilePicUrl === "" && channel === "whatsapp") {
        try {
