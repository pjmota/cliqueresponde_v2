...
import { CreateCompanyConnectionOficial, DeleteConnectionWhatsAppOficial, getTemplatesWhatsAppOficial, UpdateConnectionWhatsAppOficial } from "../libs/whatsAppOficial/whatsAppOficial.service";
import { ICreateConnectionWhatsAppOficialCompany, ICreateConnectionWhatsAppOficialWhatsApp, IUpdateonnectionWhatsAppOficialWhatsApp } from "../libs/whatsAppOficial/IWhatsAppOficial.interfaces";
...
export const update = async (
  ...
  if (["whatsapp_oficial"].includes(whatsapp.channel)) {
    try {
      ...
      await UpdateConnectionWhatsAppOficial(whatsapp.waba_webhook_id, whatsappOficial)
...
export const syncTemplatesOficial = async (req: Request, res: Response): Promise<Response> => {
  ...
  const data = await getTemplatesWhatsAppOficial(
    whatsapp.token);
