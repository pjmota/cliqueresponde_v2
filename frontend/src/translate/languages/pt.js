    ...
    translations: {
      signup: {
        ...
        toasts: {
          ...
          disabled: "Cadastro de usuários está desabilitado no momento. Por favor, tente novamente mais tarde.",
      ...
      messagesList: {
        header: {
          ...
          buttons: {
            ...
            greetingAcceptedMessage: "Você deve configurar uma mensagem de saudação ao aceitar o ticket."
          },
        },
      },
      messagesInput: {
